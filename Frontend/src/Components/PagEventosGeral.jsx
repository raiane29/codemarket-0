import {H1, Caixa2, CaixaY, Linha, Linhas, CaixaH1} from '../Styles/PagEventosGeral.js'
...
const PagAddEventosGeral = () => {
    return(
      <CaixaY className='caixaY'>
...
export default PagAddEventosGeral